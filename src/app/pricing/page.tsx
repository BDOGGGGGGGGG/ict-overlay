      ...
      <ul className="mt-6 space-y-2.5">
        {features.map((f) => (
          <li key={f} className="flex items-start gap-3 text-sm text-muted-foreground">
            <Check className={cn("h-4 w-4 mt-0.5 shrink-0", selected ? "text-primary" : "text-muted-foreground/50")} />
            {f}
          </li>
        ))}
      </ul>
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-lg mx-auto leading-relaxed">
              Pick a plan, enter your email, and get access instantly. Cancel anytime.
            </p>
          </motion.div>
          ...
          >
            <PlanCard plan="monthly" selected={plan === "monthly"} onSelect={() => setPlan("monthly")} />
            <PlanCard plan="yearly" selected={plan === "yearly"} onSelect={() => setPlan("yearly")} />
          </motion.div>
